...
import com.maratangsoft.todaysperformance.databinding.ItemRankingFragmentBinding;
...
public class RankingFragmentAdapter extends RecyclerView.Adapter<RankingFragmentAdapter.ViewHolder> {
    ...
    public RankingFragmentAdapter(Context context, ArrayList<RecyclerViewItem> itemList) {
        this.context = context;
        this.itemList = itemList;
        favoriteDB = new FavoriteDB(context);
    }
    public RankingFragmentAdapter() {
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ViewHolder(inflater.inflate(R.layout.item_ranking_fragment, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        RecyclerViewItem item = itemList.get(position);
        holder.binding.tvItemRank.setText(item.rnum);
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ItemRankingFragmentBinding binding;
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            binding = ItemRankingFragmentBinding.bind(itemView);
        }
    }
}
